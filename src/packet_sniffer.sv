/*
	This file is generated by packet_sniffer_gen.py script written by Brandon Hippe
	Arguments:
	+-----------------------+-------------------+
	|        Argument       |       Value       |
	+-----------------------+-------------------+
	| packet_sniffer_output | packet_sniffer.sv |
	+-----------------------+-------------------+
*/
...
module packet_sniffer #(
    ...
    input logic symbol_clk, resetn, en,
...
module crc #(
    ...
    input logic [CRC_LEN-1:0] crc_init, crc_poly
);
